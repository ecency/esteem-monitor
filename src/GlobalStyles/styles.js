...
export default styles=StyleSheet.create({
    ...
    headerText:{backgroundColor:myColors.headerTextColor},
    contentDashboard:{flex:1,paddingHorizontal: 20, paddingVertical: 5,backgroundColor:myColors.contentBackGroundColor},
